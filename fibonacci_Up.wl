...
FibStringCS[n_, csl_, csr_] := Select[FibStringRecurse[n], First[#] == csl && Last[#] == csr &];
...
U[p_, csl_, csr_] := Dot @@ Flatten[{Table[σ[p + 2, j, csl, csr], {j, 1, p + 1}], Table[σ[p + 2, j, csl, csr], {j, p, 1, -1}]}, 1];
