...
\newunicodechar{ρ}{\ifmmode{\rho}\else{ρ}}
\newunicodechar{σ}{\ifmmode{\sigma}\else{σ}}
\newunicodechar{α}{\ifmmode{\alpha}\else{α}}
\newunicodechar{β}{\ifmmode{\beta}\else{β}}
\newunicodechar{τ}{\ifmmode{\tau}\else{τ}}
\newunicodechar{π}{\ifmmode{\pi}\else{π}}
\newunicodechar{θ}{\ifmmode{\theta}\else{θ}}
\newunicodechar{λ}{\ifmmode{\lambda}\else{λ}}
\newunicodechar{μ}{\ifmmode{\mu}\else{μ}}
\newunicodechar{₁}{\ifmmode{_1}\else{₁}}
\newunicodechar{ⱼ}{\ifmmode{_j}\else{ⱼ}}
\newunicodechar{ₙ}{\ifmmode{_n}\else{ₙ}}
\newunicodechar{ₚ}{\ifmmode{_p}\else{ₚ}}
\newunicodechar{ⁿ}{\ifmmode{^n}\else{ⁿ}}
\newunicodechar{×}{\ifmmode{\times}\else{×}}
\newunicodechar{±}{\ifmmode{\pm}\else{±}}
\newunicodechar{⊕}{\ifmmode{\oplus}\else{⊕}}
...
% \chapter{Code for computing braid group representations for Fibonacci anyons}\label{sec:code}
...
% With the following code we get numerical values
